...
public:
	...
	std::vector<Triangle> normalize(RandomAccessIterator begin, RandomAccessIterator end);
...
template<class RandomAccessIterator>
inline std::vector<Triangle> TriangleNormalizer::normalize(RandomAccessIterator begin, RandomAccessIterator end) {
